<div class="container-fluid">
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <div class="btn btn-sm btn-danger mb-3">Hapus Keranjang</div></a>
        <a href="<?php echo base_url("welcome") ?>">
        <div class="btn btn-sm btn-primary mb-3">Lanjutkan Belanja</div></a>
        <a href="<?php echo base_url("dashboard/pembayaran") ?>">
        <div class="btn btn-sm btn-success mb-3">Pembayaran</div></a>
